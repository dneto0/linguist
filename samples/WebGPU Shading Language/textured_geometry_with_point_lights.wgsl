// Copyright © 2023 World Wide Web Consortium. All Rights Reserved.
//
...
// WebGPU Shading Language (WGSL) example.
// This is Example 1 in the Introduction to the WGSL specification.
